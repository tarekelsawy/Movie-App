...
class ServiceLocator {
  static void init() {
    ///bloc
    getIt.registerFactory(() => MovieDetailsBloc(useCaseGetMovieDetails: getIt()));
    getIt.registerFactory(() => MovieBloc(useCaseGetPlayingNowMovies:getIt(),useCaseGetPopularMovies:getIt(),useCaseGetTopRatedMovies:getIt(),useCaseGetMovieDetails: getIt()));
